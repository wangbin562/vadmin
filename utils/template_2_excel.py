            ...
            if copy_col_width:
                for i in range(col_span + 1):
                    ...
                    if col not in self.dict_width:
                        ...
                        self.w_sheet.column_dimensions[col_name].width = self.lst_col_width[r_col + i - 1]
...
class Compiler(object):
    ...
    def generate_code(self):
        ...
        lst_code.append('from utils.template_2_excel import BasePage')
        lst_code.append('')
        if self.lst_import:
...
if __name__ == "__main__":
    ...
    # generate(r"变压器温度.xlsx", "2.xlsx", is_compile=True, lst_time=lst_time, lst_1_a=lst_1_a, lst_1_b=lst_1_b, lst_1_c=lst_1_c,
    #                lst_2_a=lst_2_a, lst_2_b=lst_2_b, lst_2_c=lst_2_c, lst_3_a=lst_3_a, lst_3_b=lst_3_b, lst_3_c=lst_3_c,
    #                lst_4_a=lst_4_a, lst_4_b=lst_4_b, lst_4_c=lst_4_c, lst_5_a=lst_5_a, lst_5_b=lst_5_b, lst_5_c=lst_5_c,
    #                lst_surgical_1_a=lst_surgical_1_a, lst_surgical_1_b=lst_surgical_1_b, lst_surgical_1_c=lst_surgical_1_c,
    #                lst_surgical_2_a=lst_surgical_2_a, lst_surgical_2_b=lst_surgical_2_b, lst_surgical_2_c=lst_surgical_2_c)

    # for i in range(100):
    # generate("test.xlsx", "1.xlsx", is_compile=True, lst_progress=["2018-01-01", "2018-01-02", "2018-01-03"], week_date="2018-01-02")
